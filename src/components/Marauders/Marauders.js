...
export default function Marauders() {
    const sneak = [
        {
            id: 0,
            thumbnail: marauder1,
            ...
            <section>
                    ...
                    <div className="row align-items-center py-5">
                        <div className="col-lg-8 order-1 order-lg-0">
                            <div className="pe-lg-3">
                                <p className="fw-bold text-center text-lg-start font-size-250 font-size-md-300 mb-4">What are the Marauders?</p>
                ...
                <section id="cta">
                    <div className="container text-center py-4">
                        ...
                        <button className="btn btn-custom-2 gotham-black font-size-140" onClick={handleShowMintingNotYetAvailable}>MINT NOW</button>
                    </div>
                </section>
            </section>
