...
import mustashowBg from '../../images/mustashow-bg.webp'
import mustashowTitle from '../../images/mustashow-title.png'
import mustachiosLogo from '../../images/mustachios-logo.webp'
import ownlyLogo from '../../images/ownly-logo.png'
...
export default function Hero({ mintRascal, isSoldout, isDiscounted }) {
    ...
    return (
        <div className="overflow-hidden">
            <div className="mustashow-bg" style={{ "backgroundImage": 'url(' + mustashowBg + ')' }}>
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="d-flex flex-column justify-content-center min-vh-100 py-5">
                                <div className="pt-5 mb-5 pb-5">
                                    <img src={mustashowTitle} className="w-100 pt-lg-2 pb-5" />
                                </div>
                                <div className="text-center pb-5 pb-lg-4">
                                    <p className="text-white gotham font-size-xl-120 font-size-xxl-130">Art &middot; Gaming &middot; AR/VR/XR &middot; NFT &middot; Web3.0 &middot; Metaverse</p>
                                    <div>
                                        <img src={ownlyLogo} className="mx-3" width="110" />
                                        <img src={mustachiosLogo} className="mx-3" width="90" />
                                    </div>
                                </div>
                            </div>
                        </div>
