                ...
                <div className="row align-items-center my-5 py-lg-5">
                    ...
                    <div className="col-lg-7">
                        <div className="ps-lg-5 mb-4 mb-lg-0 pb-lg-0">
                            ...
                            <p className="text-white text-center text-lg-start font-size-xl-130 mb-4">#CanYourJPEG immerse in your day-to-day activities? Well, these Mustachios can! Try out our <a href="/ar" className="link-color-2" >Mustachio filter on Instagram</a> to see ‘em dancing in IRL.</p>
